...
class Utilitarios:
    def menu_principal(self):
        while True:
            ...
            print("|1. Utilitários Matemáticos Básicos    |")
            print("|2. Utilitários Matemáticos Avançados  |")
            print("|3. Verificadores de Números           |")
            print("|4. Utilitários de Texto               |")
            print("|5. Conversores de Unidades            |")
            print("|6. Jogos                              |")
            print("|0. Sair                               |")
            print("|======================================|")
...
class UttsMatBasicos:
    def menu_principal(self):
        print("|=======================================|")
        print("|    Utilitários Matemáticos Básicos    |")
...
class UttsMatAvanc:
    def menu_principal(self):
        while True:
            print("|=======================================|")
            print("|   Utilitários Matemáticos Avançados   |")
            print("|1. Calculadora Avançada                |")
            print("|2. Funções Matemáticas                 |")
            print("|3. Calculo de Estatística              |")
            print("|4. Resolver Equações                   |")
            print("|5. Operações com Matrizes              |")
            print("|6. Geometria                           |")
            print("|7. Teorema                             |")
            print("|0. Sair                                |")
            print("|=======================================|")
            ...
            match escolha:
                case "0": return
                case "1":
                    c21=CalculadoraAvancada()
                    c21.calculadora()
                case "2":
                    c22=FuncoesMatematicas()
                    c22.funcoes_matematicas()
                case "3":
                    c23=Estatisticas()
                    c23.estatisticas()
                case "4":
                    c24=Equacoes()
                    c24.resolver_equacao()
                case "5":
                    c25=OperacoesMatrizes()
                    c25.operacoes_matrizes()
                case "6":
                    c26=Geometria()
                    c26.geometria()
                case "7":
...
class Geometria:
    def geometria(self):
        ...
        print("|3. Calcular Perímetro do Triângulo   |")
...
class UttsTexto:
    def menu_principal(self):
        print("|=======================================|")
        print("|         Utilitários de Texto          |")
        print("|1. Analise de Texto                    |")
        print("|0. Sair                                |")
        print("|=======================================|")
        escolha = input("Escolha uma opção: ")
        match escolha:
...
class SimuladorFinanceiro:
    def menu_financeiro(self):
        ...
        print("|2. Calcular Investimento Futuro   |")
