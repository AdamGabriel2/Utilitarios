    ...
    def __init__(self):
        ...
        match escolha:
            ...
            case "10":
                ...
                z1 = NumeroComplexo(r1, i1)
                z2 = NumeroComplexo(r2, i2)
                
                menu_opcoes=["Soma","Subtração","Multiplicação","Módulo do primeiro número"]
                menu = Menu("Numeros Complexos", menu_opcoes)
                menu.desenhar()
                ...
                match escolha:
                    case "0": return
                    case "1":
                        resultado = z1.soma(z2)
                        resultado.exibir()
                    case "2":
                        resultado = z1.subtracao(z2)
                        resultado.exibir()
                    case "3":
                    ...
                    case "4":
                        ...
                        resultado.exibir()
                    case "5": print(f"Módulo: {z1.modulo()}")
...
class NumeroComplexo:
    ...
    def exibir(self):
        ...
        print(f"{self.real} {sinal} {abs(self.imaginario)}i")
...
class Fracao:
    ...
    def soma(self, outra):
        ...
        return Fracao(novo_numerador, novo_denominador).simplificar()
